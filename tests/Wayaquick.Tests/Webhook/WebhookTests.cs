...
public sealed class WebhookTests(ITestOutputHelper output)
{
    ...
    public void ConstructEvent_ParsesMixedCasing_OnValidSignature()
    {
        ...
        var evt = WayaQuickWebhook.ConstructEvent(Body, ts, sig, Secret);
    ...
    public void ConstructEvent_Throws_OnWrongSignature()
    {
        ...
        var ex = Assert.Throws<WayaQuickWebhookException>(() =>
    ...
    public void ConstructEvent_Throws_WhenBodyTamperedAfterSigning()
    {
        ...
        Assert.Throws<WayaQuickWebhookException>(() =>
            WayaQuickWebhook.ConstructEvent(tampered, ts, sig, Secret));
    ...
    public void ConstructEvent_Throws_OnStaleTimestamp_Replay()
    {
        ...
        var ex = Assert.Throws<WayaQuickWebhookException>(() =>
            WayaQuickWebhook.ConstructEvent(Body, staleTs, sig, Secret));
    ...
    public void ConstructEvent_AcceptsStaleTimestamp_WhenReplayCheckDisabled()
    {
        ...
        var evt = WayaQuickWebhook.ConstructEvent(Body, staleTs, sig, Secret, Timeout.InfiniteTimeSpan);
    ...
    {
        Assert.False(WayaQuickWebhook.VerifySignature(Body, NowMs(), signature, Secret));
    ...
    {
        var ts = NowMs();
        Assert.True(WayaQuickWebhook.VerifySignature(Body, ts, Sign(ts, Body), Secret));
    ...
    public void ConstructEvent_Throws_OnInvalidJson_WithValidSignature()
    {
        ...
        Assert.Throws<WayaQuickWebhookException>(() =>
            WayaQuickWebhook.ConstructEvent(notJson, ts, sig, Secret));
