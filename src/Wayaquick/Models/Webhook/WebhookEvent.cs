namespace WayaQuick.Models.Webhook;

/// <summary>
/// A transaction webhook delivered by WayaQuick when a payment becomes SUCCESSFUL, PARTIAL, or FAILED.
/// Construct one only via <see cref="WayaQuick.WayaQuickWebhook.ConstructEvent"/>, which verifies the
...
public sealed record WebhookEvent
{
    ...
    /// <summary>Your business name as registered on WayaQuick.</summary>
