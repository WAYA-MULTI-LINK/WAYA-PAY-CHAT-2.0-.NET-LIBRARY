...
/// <see cref="ConstructEvent"/> throws <see cref="WayaPayWebhookException"/> rather than returning a value.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
public static class WayaPayWebhook
{
    ...
    /// Throws <see cref="WayaPayWebhookException"/> if verification fails — never returns an unverified event.
    /// </summary>
        ...
        string payload, string? timestamp, string? signature, string secret, TimeSpan? tolerance = null)
    {
        ...
        {
            throw new WayaPayWebhookException("Webhook body is not valid JSON.", ex);
        }

        return evt ?? throw new WayaPayWebhookException("Webhook body deserialised to null.");
    }
...
public sealed class WayaPayWebhookException : Exception
{
    public WayaPayWebhookException(string message) : base(message) { }
    public WayaPayWebhookException(string message, Exception inner) : base(message, inner) { }
}
